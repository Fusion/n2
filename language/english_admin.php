...
$lang['admin_avatar_addMultiple_path_desc'] = 'This is the <strong>local</strong> path in which wtcBB will look for avatars. You will be displayed a listing of avatars in this directory, except for avatars already added in the database.';
...
$lang['admin_cron_add'] = 'Add wtcBB Cron';
...
$lang['admin_cron_ae_log'] = 'Log wtcBB Cron:';
...
$lang['admin_cron_ae_path_desc'] = 'This is the filename of the file you wish for wtcBB to run. Please make sure that this is a <strong>path</strong> and <strong>not</strong> a URL.';
...
$lang['admin_cron_edit'] = 'Edit wtcBB Cron';
...
$lang['admin_cron_man'] = 'wtcBB Cron Manager';
...
$lang['admin_error_cannotDelDefGroup'] = 'Sorry, but you cannot delete a default usergroup, as they are required for wtcBB to run properly.';
$lang['admin_error_cannotDeleteGroup'] = 'Sorry, but wtcBB requires this group to preserve the functionality of the bulletin board.';
...
$lang['admin_error_cron_noCrons'] = 'Sorry, but there are currently no wtcBB Crons in the database.';
...
$lang['admin_error_faqRoot'] = 'Sorry, but you cannot delete the FAQ Root entry. If you do not want the FAQ page to show on your message board, then you can disable it in the "Setup" section of "wtcBB Options".';
$lang['admin_error_fileDoesNotExist'] = 'Sorry, but the requested file name does not exist.';
$lang['admin_error_fileOpen'] = 'Sorry, but in an attempt to open, read, or write to a file, wtcBB failed. Most commonly, this is due to insufficient privileges on *nix systems. Please make sure that you have chmodded the files/directories in question to either 755 or 777.';
...
$lang['admin_error_lastForum'] = 'Sorry, but you cannot delete the last forum. At least one forum is required to exist for wtcBB to run properly.';
$lang['admin_error_lastStyle'] = 'Sorry, but you cannot delete the last style. At least one style is required to exist for wtcBB to run properly.';
$lang['admin_error_leaveOneLangLeft'] = 'Sorry, but you must have at least one language installed in order for wtcBB to run correctly.';
...
$lang['admin_error_uniqueGroupTitle'] = 'Sorry, but you must specify a unique usergroup title. wtcBB has detected that there is already a usergroup that exists with the specified title.';
...
$lang['admin_fileActions_wtcBB-Cron-System'] = 'wtcBB Cron System';
...
$lang['admin_forums_ae_viewAge_desc'] = 'This is the cut off (in days) for threads listed in the forum. Any threads older than the specified amount of days will not be shown by default. This setting will not override a user\'s setting, but only the default setting set in wtcBB Options.';
...
$lang['admin_login'] = 'Login to wtcBB 2 Admin Panel';
...
$lang['admin_log_cron'] = 'wtcBB Cron Log';
...
$lang['admin_log_cron_results'] = 'wtcBB Cron Log Search Results:';
...
$lang['admin_nav_cron_add'] = 'Add wtcBB Cron';
$lang['admin_nav_cron_man'] = 'wtcBB Cron Manager';
$lang['admin_nav_cron_title'] = 'wtcBB Cron System';
...
$lang['admin_nav_logs_cron'] = 'wtcBB Cron Log';
...
$lang['admin_nav_wtcBBOpt_title'] = 'wtcBB Options';
...
$lang['admin_options_cookieSettings_cookDomain_desc'] = 'This is the domain in which cookies will be in effect. This is useful if you have multiple sub-domains running different instances of wtcBB. Remember to keep the <strong>preceeding dot</strong>. If you are running wtcBB on your localhost, leave the cookie domain field <strong>blank</strong>.';
...
$lang['admin_options_cookieSettings_cookPath_desc'] = 'This is the path in which cookies will be set. This is useful if you have multiple instances of wtcBB on one domain. Please remember to keep the <strong>trailing slash</strong>.';
...
$lang['admin_options_dateTime_date_desc'] = 'This is the format in which the date will be presented on all wtcBB pages. It uses the PHP <a href="http://www.php.net/date">Date</a> function format.';
...
$lang['admin_options_dateTime_time_desc'] = 'This is the format in which the time will be presented on all wtcBB pages. It uses the PHP <a href="http://www.php.net/date">Date</a> function format.';
...
$lang['admin_options_userOptions_verifyEmail_desc'] = 'When this option is enabled, users will be kept in the "Awaiting Activation"  usergroup until they have verified their email address by clicking on a link in an automatically generated email sent by wtcBB.';
...
$lang['admin_style_ae_name_desc'] = 'This is the name of this style, and this is how it will be referenced throughout wtcBB.';
...
$lang['admin_title'] = 'wtcBB Admin Panel';
...
$lang['admin_usergroups_admins_cron'] = 'wtcBB Cron System:';
...
$lang['admin_usergroups_admins_logCron'] = 'Logs - wtcBB Cron';
$lang['admin_usergroups_admins_logMod'] = 'Logs - Moderator';
$lang['admin_usergroups_admins_maintenance'] = 'Maintenance:';
$lang['admin_usergroups_admins_options'] = 'wtcBB Options:';
...
$lang['admin_users_ae_censor_desc'] = 'This will completely disable the forum censor (specified in the \'Censorship\' options, under the \'wtcBB Options\' menu) for this user.';
...
$lang['admin_users_ae_lang_desc'] = 'This is the language that will be used for this user. Select "Use Forum Default" for this user to use the language specified as the default language in the "Setup" area of "wtcBB Options".';
