	...
	*/
	function actionRedirect($action_target,$param){
		...
		if($action_target == 'messages'){
			$target_url = 'index.php?act=admin&w=chat&show=messages';
		}elseif ($action_target == 'edit_message'){
			$target_url = 'index.php?act=admin&w=chat&show=edit_message';
		}elseif ($action_target == 'moderation'){
			$target_url = 'index.php?act=admin&w=chat&show=moderation';
		}elseif ($action_target == 'edit_message_moderation'){
			$target_url = 'index.php?act=admin&w=chat&show=edit_message_moderation';
		}elseif ($action_target == 'ban'){
			$target_url = 'index.php?act=admin&w=chat&show=ban';
		}elseif ($action_target == 'smilies'){
			$target_url = 'index.php?act=admin&w=chat&show=smilies';
		}elseif ($action_target == 'badwords'){
			$target_url = 'index.php?act=admin&w=chat&show=badwords';
		}elseif ($action_target == 'configuration'){
			$target_url = 'index.php?act=admin&w=chat&show=configuration';
		}
