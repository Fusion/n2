...
?>	
    	  <form action="index.php?act=admin&w=chat&show=process" method="post">
...
?>
			  <tr <?php echo $style; ?>>
				...
				<td width="8%" align="center"><a href="index.php?act=admin&w=chat&show=edit_message_moderation&id=<?php echo $value['datetime']; ?>">Edit</a></td>
				<td width="5%" align="center"><input name="timestamp[<?php echo $value['datetime']; ?>]" type="radio" value="approve">
					Approve
				</td>
			    <td width="5%" align="center"><input name="timestamp[<?php echo $value['datetime']; ?>]" type="radio" value="delete">
			    	Delete
			    </td>
			    <td width="5%" align="center"><input name="timestamp[<?php echo $value['datetime']; ?>]" type="radio" value="none" checked>
			    	None
			    </td>
			  </tr>
<?php
...
?>			  
			  ...
			  <tr>
			    <td colspan="9" align="right"><input type="submit" name="submit" class="btn" value="Moderate Messages" onclick="javascript:return confirm('Are you sure you want to Moderate Messages?')"></td>
			    </tr>
			</table>
			<input type="hidden" name="action_input" value="moderation">
