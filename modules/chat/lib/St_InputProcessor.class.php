		...
		*/
		function parseNicknameLink(){
			...
			else
			{
				...
				{
					$avatar = "whatever/{$avatar}";
				}
				$messageArray['avatar'] = $avatar; 
			}			
			// CFR-
		...
		*/
		function translateSmiley($patternArray){
			...
			foreach ($patternArray as $value){
				...
				$replacements[]   = '<img src="modules/chat/images/smilies/'.$value['image'].'" border="0" alt="'.$value['pattern'].'"/>';
			}
