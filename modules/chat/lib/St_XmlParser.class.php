	...
	class St_XmlParser{
		...
		*/
		function appendMessage($fileName,$maxMessageRotation,$newMessage){
			...
			$avatarElement =& $xmlDoc->createElement('avatar');
			...
			$avatarElement->appendChild($xmlDoc->createTextNode($newMessage['avatar']));			
		...
		function deleteMessage($fileName,$messageId){
			...
			foreach ($messageArray as $key=>$value){
				if(!in_array($value['datetime'],$messageId)){		
					...
					$avatarElement->appendChild($xmlDoc->createTextNode($value['avatar']));
